...
boost::unordered_map<int, HappySupremacy_BetMaxCFGData>& HappySupremacy_BetMaxCFG::GetMapData()
{
	return mMapData;
}
...
{
	std::ifstream readStream("../Config/HappySupremacy_BetMaxCFG.xml", std::ios::binary);
