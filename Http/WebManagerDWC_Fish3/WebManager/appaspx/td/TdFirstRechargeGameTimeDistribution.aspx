<%@ Page Title="" Language="C#" MasterPageFile="~/appaspx/td/TdCommon.master" AutoEventWireup="true" CodeBehind="TdFirstRechargeGameTimeDistribution.aspx.cs" Inherits="WebManager.appaspx.td.TdFirstRechargeGameTimeDistribution" %>
<asp:Content ID="Content1" ContentPlaceHolderID="tdHeadContent" runat="server">
	...
	<script type="text/javascript">
	    ...
	    seajs.use("../../Scripts/td/TdFirstRechargeGameTimeDistribution.js");
	</script>
    <style type="text/css">
