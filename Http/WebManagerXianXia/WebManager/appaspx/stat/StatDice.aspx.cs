...
{
    public partial class StatDice : System.Web.UI.Page
    {
        private static string[] s_head = new string[] { "房间", "系统总收入", "系统总支出", "盈亏情况", "实际盈利率", "选择" };
        ...
        protected void onReset(object sender, EventArgs e)
        {
            ...
            OpRes res = mgr.doDyop(p, DyOpType.opTypeDiceParamAdjust, user);
        ...
        protected void genExpRateTable(Table table)
        {
           ...
           // long totalOutlay = 0;
            ...
            OpRes res = mgr.doQuery(null, QueryType.queryTypeDiceEarnings, user);
            Dictionary<int, ResultFishlordExpRate> qresult
                = (Dictionary<int, ResultFishlordExpRate>)mgr.getQueryResult(QueryType.queryTypeDiceEarnings);
            ...
            for (i = 1; i <= 1; i++)
            {
                ...
                if (qresult.ContainsKey(i))
                {
                    ...
                    m_content[1] = ItemHelp.showMoneyValue(r.m_totalIncome).ToString();
                    m_content[2] = ItemHelp.showMoneyValue(r.m_totalOutlay).ToString();
                    m_content[3] = ItemHelp.showMoneyValue(r.m_totalIncome - r.m_totalOutlay).ToString();
                    m_content[4] = r.getFactExpRate();
                ...
                m_content[5] = Tool.getCheckBoxHtml("roomList", i.ToString(), false);
        ...
        protected void addStatFoot(Table table, long totalIncome, long totalOutlay)
        {
            ...
            m_content[0] = "总计";
            // 总收入
            m_content[1] = totalIncome.ToString();
            // 总支出
            m_content[2] = totalOutlay.ToString();
            // 总盈亏
            m_content[3] = (totalIncome - totalOutlay).ToString();
            m_content[4] = "";
            m_content[5] = "";
