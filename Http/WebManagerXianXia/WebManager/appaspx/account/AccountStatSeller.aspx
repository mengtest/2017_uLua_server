<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AccountStatSeller.aspx.cs" Inherits="WebManager.appaspx.account.AccountStatSeller" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth">
        ...
        <%-- 管理员 
        <div id="divSeller" runat="server" style="margin-top:10px">
            售货亭管理员:&nbsp;&nbsp;<asp:DropDownList ID="m_sellerMgr" runat="server" CssClass="cDropDownList"></asp:DropDownList>
        </div> --%>
