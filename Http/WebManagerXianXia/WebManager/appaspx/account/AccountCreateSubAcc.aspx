<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AccountCreateSubAcc.aspx.cs" Inherits="WebManager.appaspx.account.AccountCreateSubAcc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="../../Scripts/account/AccountCreateSubAcc.js" type="text/javascript"></script>
    <style type="text/css">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cSafeWidth">
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    <input type="button" id="btnCreateSub" name="btnDelPlayer" value="创建"/>
