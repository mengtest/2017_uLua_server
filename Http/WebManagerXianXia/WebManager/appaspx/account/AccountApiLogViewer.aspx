<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AccountApiLogViewer.aspx.cs" Inherits="WebManager.appaspx.account.AccountApiLogViewer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
	...
	<script type="text/jsavascript" src="/Scripts/DateRange/js/daterangepicker.jQuery.js"></script>
