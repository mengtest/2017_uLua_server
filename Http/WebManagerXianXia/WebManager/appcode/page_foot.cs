...
//////////////////////////////////////////////////////////////////////////
// 管理员对会员的上分下分情况记录
public class PageGmScoreLog : PageGen
{
    public string m_time = "";
    public string m_opAcc = "";
    public string m_dstAcc = "";
    public int m_orderState = -1;

    public PageGmScoreLog(int rowEachPage)
        : base(rowEachPage)
    {
    }
    ...
    public override bool parse(HttpRequest Request)
    {
        ...
        str = Request.QueryString["opAcc"];
        if (str != null)
        {
            m_opAcc = str;
            res = true;
        }
        str = Request.QueryString["dstAcc"];
        if (str != null)
        {
            m_dstAcc = str;
            res = true;
        }
        str = Request.QueryString["orderState"];
        if (str != null)
        {
            m_orderState = Convert.ToInt32(str);
            res = true;
        }
        return res;
    }
...
//////////////////////////////////////////////////////////////////////////
// 游戏历史记录
public class PageGameHistory : PageGen
{
    public string m_time = "";
    public int m_gameIndex;
    public int m_bound = -1;

    public PageGameHistory(int rowEachPage)
        : base(rowEachPage)
    {
    }
    ...
    public override bool parse(HttpRequest Request)
    {
        ...
        str = Request.QueryString["gameIndex"];
        if (str != null)
        {
            m_gameIndex = Convert.ToInt32(str);
            res = true;
        }
        str = Request.QueryString["bound"];
        if (!string.IsNullOrEmpty(str))
        {
            m_bound = Convert.ToInt32(str);
            res = true;
        }
        return res;
    }
...
//////////////////////////////////////////////////////////////////////////
public class PageAccountSubPlayer : PageGen
{
    public string m_creator = "";
    
    public PageAccountSubPlayer(int rowEachPage)
        : base(rowEachPage)
    {
    }
    ...
    public override bool parse(HttpRequest Request)
    {
        ...
        string str = Request.QueryString["creator"];
        if (str != null)
        {
            m_creator = str;
            res = true;
