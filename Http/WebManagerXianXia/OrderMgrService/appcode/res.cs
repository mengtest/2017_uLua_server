...
{
    // 处理订单的总命令
    public const int CMD_ORDER = 1;
}

public struct SubCmd
{
    // 一个新的订单
    public const int SUB_CMD_NEW_ORDER = 1;

    // 重新检测处理中的订单，看是否处理完毕了
    public const int SUB_CMD_RECHECK_PROCESSING = 2;

    // 重新处理失败订单
    public const int SUB_CMD_REPROCESS_FAILED_ORDER = 3;
}

//////////////////////////////////////////////////////////////////////////

public class ApiCallOrderInfo : OrderInfo
{
    // api密钥，对api回调数据加密
    public string m_apiDevKey = "";
}
