<%@ Page Title="" Language="C#" MasterPageFile="~/appaspx/stat/StatCommonBaccarat.master" AutoEventWireup="true" CodeBehind="BaccaratPlayerBanker.aspx.cs" Inherits="WebManager.appaspx.stat.baccarat.BaccaratPlayerBanker" %>

<asp:Content ID="Content2" ContentPlaceHolderID="StatCommonBaccarat_HeadContent" runat="server">
	...
	<script type="text/javascript">
	    $(function () {
	        $('#MainContent_stat_common_StatCommonBaccarat_Content_txtTime').daterangepicker({ arrows: false });
	    });
	</script>
</asp:Content>
