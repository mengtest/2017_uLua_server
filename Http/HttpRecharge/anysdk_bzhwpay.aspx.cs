...
{
    public partial class anysdk_bzhwpay : System.Web.UI.Page
    {
        Dictionary<string, int> pay_code = new Dictionary<string, int>();
        
        protected void Page_Load(object sender, EventArgs e)
        {
            pay_code["cn.huntergame.cpmcard.319"] = 1;
            pay_code["cn.huntergame.cpcoin.179"] = 2;
            pay_code["cn.huntergame.cpcoin.349"] = 3;
            pay_code["cn.huntergame.cpcoin.529"] = 4;
            pay_code["cn.huntergame.cpcoin.879"] = 5;
            pay_code["cn.huntergame.cpcoin.1750"] = 6;
            pay_code["cn.huntergame.cpcoin.3500"] = 7;
            pay_code["cn.huntergame.cpgem.179"] = 8;
            pay_code["cn.huntergame.cpgem.349"] = 9;
            pay_code["cn.huntergame.cpgem.529"] = 10;
            pay_code["cn.huntergame.cpgem.879"] = 11;
            pay_code["cn.huntergame.cpgem.1750"] = 12;
            pay_code["cn.huntergame.cpgem.3500"] = 13;
            ...
            try
            {
                ...
                {
                    int payCode = pay_code[(data["product_id"].ToString())];
                    if (payCode < 0)
                    {
